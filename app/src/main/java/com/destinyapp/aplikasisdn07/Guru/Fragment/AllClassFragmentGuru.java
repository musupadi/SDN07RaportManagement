 ...
 */
public class AllClassFragmentGuru extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_all_class_guru, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecycler = (RecyclerView)view.findViewById(R.id.recyclerPilihNilaiGuru);
    ...
    private void getData(){
        ...
        GetKelas.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                mAdapter = new AdapterAllClass(getActivity(),mItems);
