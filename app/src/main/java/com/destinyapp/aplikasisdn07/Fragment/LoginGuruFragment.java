...
public class LoginGuruFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_login_guru, container, false);
    }
    ...
    private void CheckLogin(){
        ...
        Call<ResponseModel> login = api.loginGuru(Username,Password);
        login.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                if(ress.equals("succes")){
                    ...
                    Intent intent = new Intent(getActivity(), MainGuruActivity.class);
