...
import com.destinyapp.aplikasisdn07.Guru.Adapter.AdapterMengajarGuru;
 ...
 */
public class JadwalBelajarSiswaFragment extends Fragment {
    ...
    public JadwalBelajarSiswaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_jadwal_belajar_siswa, container, false);
    }
    ...
    private void getData(final String HariIni){
        ...
        getJadwal.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                mAdapter = new AdapterMengajarGuru(getActivity(),mItems);
