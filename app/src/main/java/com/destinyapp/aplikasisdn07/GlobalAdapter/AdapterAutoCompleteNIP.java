...
public class AdapterAutoCompleteNIP extends ArrayAdapter<DataModel> {
    private List<DataModel> dmListFull;

    public AdapterAutoCompleteNIP(@NonNull Context context, @NonNull List<DataModel> countryList) {
